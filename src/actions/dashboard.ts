...
export async function getDashboardStats(): Promise<DashboardStats | null> {
  ...
  const statsPromise = (async () => {
    ...
    try {
      // Current month transactions - limit to 500 to prevent overload
      ...
      // Previous month transactions - limit to 500
      ...
      // Get all current month transactions for revenue by brand - limit to 500
      ...
      // Recent transactions with joins - limit to 10

...
const WorkSlider = () => {
  ...
  return (
    <section className="w-full min-h-screen flex items-center py-20 overflow-hidden">
      <div className="max-w-[1480px]  px-3 lg:px-12 w-full mx-auto grid grid-cols-1 lg:grid-cols-[1fr_1.2fr] gap-12 lg:gap-24 h-full min-h-[600px]">
        <div className="flex flex-col justify-between h-full pt-4">
          <div className="mb-16 lg:mb-0">
            ...
            <h2 className="text-4xl sm:text-5xl lg:text-[3.5rem] leading-[1.1] mb-6 font-heading text-muted-foreground">
              A <span className="text-foreground">System Built</span> for <AnimatedShinyText>Structured Execution</AnimatedShinyText>
            </h2>
              ...
              <div className="image-overlay w-full h-full relative flex items-center justify-center lg:justify-end">
                <div className="relative w-full h-full">
                  <Image
                    ...
                    alt={slide.title}
                    fill
                    className="object-contain object-right grayscale contrast-125 brightness-90"

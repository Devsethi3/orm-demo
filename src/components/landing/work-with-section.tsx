...
const workData: WorkItem[] = [
  {
    ...
    description:
      "Building from idea to MVP and need a strong foundation from day one.",
    icon: "/icons/bulb.svg",
  },
  {
    title: "Startup Teams",
    description:
      "Moving fast and need structure to scale without breaking their product.",
  ...
  },
  {
    ...
    description:
      "Launching new products that must meet compliance and system-level requirements.",
...
const WhoWeWorkWith: React.FC = () => {
  return (
    <section className="bg-black text-white py-16 sm:py-20 md:py-24 w-full flex flex-col items-center selection:bg-white selection:text-black">
      <div className="max-w-[1480px] mx-auto flex justify-center flex-col items-center lg:px-12 px-3">
        <div className="flex flex-col items-center text-center max-w-2xl mb-12 sm:mb-16 md:mb-20">
          ...
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-heading font-medium text-muted-foreground mb-4 sm:mb-6 px-4">
            Who <span className="text-foreground"> We Work</span>{" "}
            <AnimatedShinyText>With</AnimatedShinyText>
          </h2>

          <p className="text-muted-foreground text-sm sm:text-base md:text-lg leading-relaxed font-light px-4">

  ...
  return (
    <div className="w-full flex flex-col bg-black text-white selection:bg-gray-800 selection:text-white">
      <section className="pt-20">
        <div className="max-w-[1480px] lg:px-12 px-3 mx-auto">
      ...
      <section className="relative w-full py-32 px-6 flex flex-col items-center justify-center overflow-hidden min-h-screen">
        ...
        <div className="relative z-10 w-full max-w-5xl mx-auto flex flex-col items-center">
          ...
          <div className="bg-white text-black w-full max-w-[480px] lg:p-7 p-6 relative shadow-2xl">
            <div className="relative z-10">
              ...
              <Link href="/contact-us" className="block w-full">
                <Button className="group bg-black hover:bg-black/90 w-full" variant={'secondary'}>

...
const includedFeatures = [
  {
    ...
    description:
      "Responsible for architecture decisions and technical oversight.",
  },
  {
...
export default function Model() {
  return (
    <section className="relative w-full py-24 bg-black  selection:bg-black selection: overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-[1408px] px-3 lg:px-12 mx-auto flex flex-col">
        <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-8 mb-16">
          <div className="flex flex-col items-start">
            <div className="flex items-center gap-3 mb-6">
              <Square className="size-3 fill-white " strokeWidth={0} />
              <span className="uppercase font-chivo-mono lg:text-sm text-xs">
                STRUCTURE
              </span>
            </div>

            <h2 className="text-3xl text-muted-foreground sm:text-5xl md:text-[3.5rem] leading-[1.1] ">
              Execution <span className="text-foreground">Model</span>
            </h2>
          </div>
